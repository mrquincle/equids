...
bool PRINT_LAND_MARKS=false;
bool PRINT_ROB_POS=false;
...
Map::Map(double* odometry,RobotBase::RobotType robot_type) {
	...
	memcpy(this->odometry, odometry, 10*sizeof(double));
